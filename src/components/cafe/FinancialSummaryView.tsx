...
import { DollarSign, CreditCard, Ban, FileSignature, AlertTriangle, MinusCircle, Hourglass, Landmark } from 'lucide-react';
...
const FinancialSummaryView: React.FC<FinancialSummaryViewProps> = ({ stats, allUnpaidOrdersTotal, isTodayClosedOut, onStartEndDay }) => {
    ...
    return (
        <div className="p-4 md:p-6 h-full overflow-y-auto bg-background">
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
                ...
                <Button onClick={onStartEndDay} disabled={isTodayClosedOut}>
