...
const AdvancedReconciliationModal: React.FC<{
    isOpen: boolean;
    onOpenChange: (open: boolean) => void;
    stats: PeriodStats | null;
}> = ({ isOpen, onOpenChange, stats }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-5xl max-h-[85vh] flex flex-col p-0 gap-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 p-6 flex-1 overflow-hidden">
...
const ReconciliationView: React.FC<{
    ...
    return (
        <>
                ...
                <DialogContent className="max-w-7xl max-h-[90vh] h-[90vh] flex flex-col p-0 gap-0 overflow-hidden">
                    ...
                    {!stats ? <LoadingSpinner /> : (
                        <ScrollArea className="flex-1">
                            <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0">
            ...
            {isAdvancedModalOpen && <AdvancedReconciliationModal isOpen={isAdvancedModalOpen} onOpenChange={setIsAdvancedModalOpen} stats={stats} />}
        </>
    );
}
