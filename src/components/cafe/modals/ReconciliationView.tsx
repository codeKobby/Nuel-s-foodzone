...
const ReconciliationView: React.FC<ReconciliationViewProps> = ({ stats, orders, onBack, setActiveView }) => {
    ...
    }, [totalCountedCash, expectedCash, deductCustomerChange, stats.changeOwedForPeriod]);
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-sm text-muted-foreground mt-3">
                                            {deductCustomerChange 
                                                ...
                                                : "Change will be counted as part of available cash"
                                            }
                                        </p>
                                    </CardContent>
                                </Card>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 rounded-lg bg-secondary space-y-2">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <p className="font-semibold">{formatCurrency(totalCountedCash - (deductCustomerChange ? stats.changeOwedForPeriod : 0))}</p>
                                            </div>
                                            <Separator />
